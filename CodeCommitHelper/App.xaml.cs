using CodeCommitHelper.Activation;
using CodeCommitHelper.Contracts.Services;
using CodeCommitHelper.Core.Contracts.Services;
using CodeCommitHelper.Core.Services;
using CodeCommitHelper.Helpers;
using CodeCommitHelper.Models;
using CodeCommitHelper.Notifications;
using CodeCommitHelper.Services;
using CodeCommitHelper.ViewModels;
using CodeCommitHelper.Views;

using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.Hosting;
using Microsoft.UI.Xaml;

namespace CodeCommitHelper;
